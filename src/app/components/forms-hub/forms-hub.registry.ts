...
export const HR_FORM_TABS: HrFormTab[] = [
  ...
  { id: 'processing', tabText: 'Processing', title: 'Payroll Processing', category: 'Payroll', description: 'Run payroll cycles and review processing outcomes.', route: '/payroll-master' },
